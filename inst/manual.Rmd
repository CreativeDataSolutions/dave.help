...
output:
  html_document:
    #css: !r system.file(package='dave.help','www/css/darkly.min.css') ...missing font deps and not found? 
    toc: yes
    toc_depth: 2
    toc_float:
      collapsed: no
...
`r make_alert(message='<h4>This is a beta release which is being actively developed.</h4>',color='#377eb8')`
...
#----------
fig_right<-TRUE
path<-'figs/dave.network/enrich/'
link_name<-'dave.network.enrich' # !TODO update app help
section_links<-create_links(link_name)

#calculate menue
enrich_description<-'<h4>This module is used to combine and visualize networks.</h4>'
...
#----------
fig_right<-TRUE
path<-'figs/dave.network/visualize/'
link_name<-'dave.network.visualize' # !TODO update app help
section_links<-create_links(link_name)

#calculate menue
vis_description<-'<h4>Use network mapping to plot and enrich networks.</h4>'
 # Network mapping can be used to integrate statistical, functional and predictive modeling results.</h4>
...
methods<-list(
              ...
              list(text="Modify and filter visualization of edges or relationships.",
                fig= paste0(path,'edges_ui.png'),  
                fig_right=fig_right,4),
              list(text="Customize network global properties.",
                fig= paste0(path,'canvas_ui.png'),  
                fig_right=fig_right,4),
              list(text="Visualize and modify plot for the report.",
